...
import {UniswapV2Arb1} from "src/periphery/UniswapV2Arb1.sol";

// Test arbitrage between UniswapV2 and SushiswapV2
...
contract UniswapV2Arb1Test is Test {
    ...
    function setUp() public {
        ...
        // user has DAI, approve arb to spend DAI
        deal(DAI, user, 10_000e18);
        vm.prank(user);
    ...
    function test_swap() public {
        ...
        console2.log("Profit DAI:", bal1 - bal0);
    }
